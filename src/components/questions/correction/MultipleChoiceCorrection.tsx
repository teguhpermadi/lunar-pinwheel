...
interface MultipleChoiceCorrectionProps {
    ...
    keyAnswer?: any;    // string[] (ids)
    isMultiple?: boolean;
}

export default function MultipleChoiceCorrection({ options, studentAnswer, keyAnswer, isMultiple = false }: MultipleChoiceCorrectionProps) {
